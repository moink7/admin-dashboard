    ...
    <div className="adminContainer">
        ...
        <section>
            <div>
                ...
                backgroundColor={categories.map((i)=> `hsl(${i.value*6},${i.value}%, 50%)`)} 
                legends = {false}
                offset={[0, 0, 0, 80]}/>
            </div>
        ...
        <section>
            <div>
                ...
                data={[32, 18, 5, 23, 16]}
                backgroundColor={["hsl(269,80%,40%)", "hsl(19,80%,40%)","hsl(69,80%,40%)","hsl(300,80%,40%)", "rgb(53, 162, 255)"]} 
                legends = {false}
                offset={[0, 80]}
                />
            </div>
        ...
        <section>
            <div>
                <PieChart labels={["Teenager (Below 20)", "Adult (20-40)", "Old (Above 40)"]}
                data={[30, 250, 25]}
                backgroundColor={[
                    `hsl(10,80%, 80%)`,
                    `hsl(10,80%, 50%)`,
        ...
        <section>
            <div>
                ...
                data={[40, 250]}
                backgroundColor={[`hsl(335,100%,40%)`, "hsl(53, 98%, 50%)"]} 
                offset={[0, 80]}
                />
            </div>
        </section>
